...
//let mode = 1;
if (localStorage.getItem("likes2") == undefined) localStorage.setItem("likes2", 6);

window.addEventListener('load', function() {
   
    if (localStorage.getItem("likes2") == 7) {

        document.getElementById("nLikes").innerHTML = "7";
        document.getElementById("like").src="../pics/heart_full.png"
    
    }

    let comment_list = JSON.parse(localStorage.getItem("comments2"));
...
function setMode() {
    ...
    if (mode == 0) {
        ...
        document.getElementById("mike_light").style.display = "none";
        document.getElementById("mike_dark").style.display = "block";
        ...
        document.getElementById("mike_light").style.display = "block";
        document.getElementById("mike_dark").style.display = "none";
...
function toggleLike() {
    ...
    let likes = localStorage.getItem("likes2");
    if (likes == 6){
        
        localStorage.setItem("likes2", 7);
        document.getElementById("nLikes").innerHTML="7";
        document.getElementById("like").src="../pics/heart_full.png"

    } else {
        
        localStorage.setItem("likes2", 6);
        document.getElementById("nLikes").innerHTML="6";
